...
<div class="vaccine-result">
    <div class="flex-container ml-6 mr-6 justify-between align-items-center mt-52 mb-32">
        <div class="ml-24"><a href="/" class="logo"></a></div>
        <div onclick="APP.toogleLang()" class="translate-button flex-container mt-6 mr-24 align-items-center">
            <div class="mr-8">
                <div class="lang-image row">
                    <div class="col-4">
                        <img src="storage/214.png" alt="sdf">
                    </div>
                    <div class="lang-ru col-3">
    ...
    <div>
        <div class="status-container mt-28">
            ...
            <div class="status-container-inner"><h4 class="title-h4 white status-title main-title"></h4>
                <div class="status mt-12 text-plain small-text bold"><span class="status-value hide not-found"></span>
                    <span class="status-value hide cert-name"></span></div>
                <h4 class="title-h4 white status-title mt-12"><span class="num-symbol">№</span> <span
                        class="unrz"></span></h4></div>
        </div>
        ...
        <div class="mt-24"><a href="/" class="button close"></a> <a download rel="noopener" target="_blank"
                                                                    class="button download hide"></a></div>
    </div>
</div>
